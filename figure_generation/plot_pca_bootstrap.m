function [bs_exp, obs_exp, nkeep, plot_handles] = plot_pca_bootstrap(data,nreps,varargin)
...
[~, ~, bs_exp] = bootstrap_pca_nullmodel(data,nreps,max_n);
[null_ph, null_lh, mu_bs_exp, null_ci95] = plot_model(bs_exp,color_null,ci,mode);
null_lh.LineStyle = '-';
